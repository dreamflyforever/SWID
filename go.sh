...
gcc -O2 common.c rs_emon.c buffer.c linux.c signalAnalyserTimeMatch2.c tinycthread.c util.c voiceRecognizer.c voiceRecog.c kiss_fft.c kiss_fftr.c circleQueue.c my_poolAlloc.c my_vector.c voiceRecogDemo.c -o main -lm -pthread
